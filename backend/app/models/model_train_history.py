...
class ModelTrainHistory(Base):
    ...
    crypto_model_path: Mapped[str | None] = mapped_column(Text, nullable=True)
    climate_model_path: Mapped[str | None] = mapped_column(Text, nullable=True)
    crypto_active: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default="false")
    climate_active: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default="false")
