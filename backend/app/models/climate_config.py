...
class ClimateConfig(Base):
    __tablename__ = "climate_configs"
    ...
    series_tickers: Mapped[str] = mapped_column(String(512), default="KXHIGHTSFO,KXHIGHTATL,KXHIGHTNOLA,KXHIGHTPHX,KXLOWTNYC,KXLOWTCHI")
    min_volume_24h: Mapped[int] = mapped_column(Integer, default=20)
