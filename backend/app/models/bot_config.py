...
class BotConfig(Base):
    ...
    min_edge_cents: Mapped[float] = mapped_column(Float, default=3.0)
    min_liquidity: Mapped[float] = mapped_column(Float, default=0.0)
    max_position_cents: Mapped[int] = mapped_column(Integer, default=200)
    ...
    take_profit_cents: Mapped[int] = mapped_column(Integer, default=5)
    ...
    min_yes_prob: Mapped[int] = mapped_column(Integer, default=20)
    ...
    spot_take_profit_pct: Mapped[float] = mapped_column(Float, default=2.0)
    spot_stop_loss_pct: Mapped[float] = mapped_column(Float, default=5.0)
    spot_buy_amount_usd: Mapped[int] = mapped_column(Integer, default=50)
    spot_max_position_usd: Mapped[int] = mapped_column(Integer, default=500)
