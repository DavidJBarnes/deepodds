...
class BotConfig(Base):
    ...
    spot_take_profit_pct: Mapped[float] = mapped_column(Float, default=3.0)
    spot_stop_loss_pct: Mapped[float] = mapped_column(Float, default=2.0)
    ...
    settlement_arb_enabled: Mapped[bool] = mapped_column(Boolean, default=False)
