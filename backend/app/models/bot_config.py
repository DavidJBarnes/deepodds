...
class BotConfig(Base):
    ...
    strategy: Mapped[str] = mapped_column(String(16), default="settlement_arb")
    ...
    take_profit_cents: Mapped[int] = mapped_column(Integer, default=8)
    stop_loss_cents: Mapped[int] = mapped_column(Integer, default=8)
    ...
    settlement_arb_max_minutes: Mapped[int] = mapped_column(Integer, default=180)
    ...
    settlement_arb_regime_filter: Mapped[bool] = mapped_column(Boolean, default=False)
    settlement_arb_min_fear_greed: Mapped[int] = mapped_column(Integer, default=25)
    max_portfolio_risk_cents: Mapped[int] = mapped_column(Integer, default=0)
    polymarket_enabled: Mapped[bool] = mapped_column(Boolean, default=False)
    polymarket_min_edge_cents: Mapped[float] = mapped_column(Float, default=3.0)
    polymarket_max_exposure_cents: Mapped[int] = mapped_column(Integer, default=5000)
    polymarket_min_liquidity: Mapped[float] = mapped_column(Float, default=100.0)
